...
uint16_t ColorPalette::GetGradationColor(uint16_t base_color, uint16_t mark_color, float_t ratio){
    /* ratio : 0.0 to 1.0 */
    ...
    Color2RGB(mark_color, rgb_mark);

    float_t red =  (float_t)(rgb_mark[0] - rgb_base[0])*ratio + (float_t)rgb_base[0];
    float_t green = (float_t)(rgb_mark[1] - rgb_base[1])*ratio + (float_t)rgb_base[1];
    float_t blue = (float_t)(rgb_mark[2] - rgb_base[2])*ratio + (float_t)rgb_base[2];
